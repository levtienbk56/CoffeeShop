...
public class UserServiceTest {
	...
	public void test1Insert() {
		...
		assertEquals(-1, userService.insertUser(new User(null, null, null, null)));
		assertEquals(-1, userService.insertUser(new User(null, null, null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User(null, null, null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User(null, "", null, null)));
		assertEquals(-1, userService.insertUser(new User(null, "", null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User(null, "", null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User(null, "testhrs123@@", null, null)));
		assertEquals(-1, userService.insertUser(new User(null, "testhrs124@@", null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User(null, "testhrs125@@", null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User("", null, false, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("", null, false, "SELLER")));
		assertEquals(-1, userService.insertUser(new User("", "", null, null)));
		assertEquals(-1, userService.insertUser(new User("", "", null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("", "", null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User("", "testhrs123@@", null, null)));
		assertEquals(-1, userService.insertUser(new User("", "testhrs124@@", null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("", "testhrs125@@", null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User("admin", null, null, null)));
		assertEquals(-1, userService.insertUser(new User("admin", null, null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("admin", null, null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User("admin", "", null, null)));
		assertEquals(-1, userService.insertUser(new User("admin", "", null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("admin", "", null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User("admin", "testhrs123@@", null, null)));
		assertEquals(-1, userService.insertUser(new User("admin", "testhrs124@@", null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("admin", "testhrs125@@", null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User("testhrs-123", null, null, null)));
		assertEquals(-1, userService.insertUser(new User("testhrs-124", null, null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("testhrs-125", null, null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User("testhrs-132", "", null, null)));
		assertEquals(-1, userService.insertUser(new User("testhrs-133", "", null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("testhrs-134", "", null, "SELLER")));
		...
		assertEquals(-1, userService.insertUser(new User("testhrs-141", "testhrs123@@", null, null)));
		assertEquals(-1, userService.insertUser(new User("testhrs-142", "testhrs124@@", null, "ADMIN")));
		assertEquals(-1, userService.insertUser(new User("testhrs-143", "testhrs125@@", null, "SELLER")));
